...
const Admin = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold font-poppins text-shadow-sm">
        Dashboard
      </h1>
      <p className="text-xl text-gray-600 mb-4">
        Selamat datang di halaman admin,{" "}
        <span className="font-semibold text-teal-500">{currentUser.nama}</span>
      </p>
      <div className="flex items-center justify-center gap-2 bg-white w-fit shadow-lg rounded-lg p-4 px-8">
        <div className="rounded-full p-3 bg-blue-300">
          <svg
            class="w-8 h-8 scale-[1.1] text-blue-700"
            viewBox="0 0 24 24"
            fill="none"
